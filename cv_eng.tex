...
Java, Elixir, C\#, Javascript, Python, Go, Groovy, C, SQL

{\sl Web and Mobile Development} \\
Android, Xamarin, Javascript, HTML, CSS, AngularJS, Sails.js
...
{\sl Software Developer} \hfill September 2018 - Present\\
Bonnier Broadcasting, Stockholm
\begin{itemize} \itemsep -2pt % Reduce space between items
\item Integrating third party services 
\end{itemize}
